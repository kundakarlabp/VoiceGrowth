    ...
    val settingsFlow: Flow<AppSettings> = context.dataStore.data
        ...
        .map { preferences ->
            AppSettings(
                ...
                onlyProcessOver30Sec = preferences[PreferencesKeys.ONLY_PROCESS_OVER_30_SEC] ?: false,
                uploadAudio = preferences[PreferencesKeys.UPLOAD_AUDIO] ?: true,
                uploadTranscript = preferences[PreferencesKeys.UPLOAD_TRANSCRIPT] ?: false,
                ...
                driveFolderHierarchy = preferences[PreferencesKeys.DRIVE_FOLDER_HIERARCHY] ?: "VoiceGrowth/Audio",
